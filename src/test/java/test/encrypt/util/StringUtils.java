...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	 ...
	 * @Title: checkContain
	 * @author wuruiding
	 * @date 2018年8月28日 下午5:31:50
	 * @Description: TODO  
	 * @param configStr 配置项字符串
	 * @param splitSign 切割符
	 * @param obj 需要判断的某个值
	 * @return  
	 * @throws
	 */
	public static Boolean checkContain(String configStr, String splitSign, Object obj) {
	
		String[] split = configStr.split(splitSign);
		for (String string : split) {
			if(Objects.equals(string, String.valueOf(obj))) {
				return true;
			}
		}
		return false;
